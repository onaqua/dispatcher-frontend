...
// export type ClientEditingProps<T extends Client> = {
//     data: T;
//     onUpdate?(id: number, data: T): Promise<Client>;
//     onDelete?(id: number): Promise<void>;
//     onCreate?(data: T): Promise<Client>;
// };

// const CarEditingItem = <T extends Client>(
